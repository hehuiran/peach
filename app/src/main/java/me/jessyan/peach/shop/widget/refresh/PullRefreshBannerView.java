...
public class PullRefreshBannerView extends PullRefreshView {


    public PullRefreshBannerView(Context context) {
        super(context);
        initGesture();
    }

    public PullRefreshBannerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initGesture();
    }

    public PullRefreshBannerView(Context context, AttributeSet attrs, int defStyle) {
