...
public interface WithdrawContract {
    ...
    interface View extends IView {
        ...
        void onBalanceSuccess(String balance);
    ...
    interface Model extends IModel {
        ...
        Observable<Optional<WithDrawBean>> getBalance();

        Observable<Optional<String>> withdraw(String money, String mobile, String verifyCode);
    }
}
