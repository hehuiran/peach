 ...
 * description:
 */
public class IncomeDetailAdapter extends BaseQuickAdapter<IncomeReportsListBean.DataBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, IncomeReportsListBean.DataBean item) {
