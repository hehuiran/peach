...
public interface IncomeContract {
    ...
    interface View extends IView {
        void onGetIncomeReportsDetailsSuccess(IncomeReportsDetailsBean.DataBean data);
    }

    //Model层定义接口,外部只需关心Model返回的数据,无需关心内部细节,即是否使用缓存
    interface Model extends IModel {
        Observable<IncomeReportsDetailsBean> getIncomeReportsDetails(String shopType);
    }
}
