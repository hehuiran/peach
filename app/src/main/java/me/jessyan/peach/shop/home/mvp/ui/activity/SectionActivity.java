...
import me.jessyan.peach.shop.home.di.component.DaggerSectionComponent;
import me.jessyan.peach.shop.home.mvp.contract.SectionContract;
import me.jessyan.peach.shop.home.mvp.presenter.SectionPresenter;
 ...
 * ================================================
 */
public class SectionActivity extends BaseActivity<SectionPresenter> implements SectionContract.View {
    ...
    public static void launcher(Context context, String title, int activityType) {
        Intent intent = new Intent(context, SectionActivity.class);
        intent.putExtra(IntentExtra.TITLE, title);
        intent.putExtra(IntentExtra.ACTIVITY_TYPE, activityType);
        context.startActivity(intent);
    }

    @Override
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerSectionComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_section; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        mActivityType = intent.getIntExtra(IntentExtra.ACTIVITY_TYPE, -1);
    ...
    private void initRecyclerView() {
        ...
        mAdapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
            ...
            public void onLoadMoreRequested() {
                mPresenter.fetchSectionData(false, false, mSort, mActivityType);
            }
        }, mRecyclerView);
    ...
    private void refreshData(boolean showLoading) {
        mPresenter.fetchSectionData(true, showLoading, mSort, mActivityType);
    }
    ...
    @Override
    public void onFetchSectionDataSuccess(List<GoodsBean> list) {
    ...
    @Override
    public void onFetchSectionDataFailed() {
        boolean isLoadMore = mAdapter.isLoading();
        if (isLoadMore) {
