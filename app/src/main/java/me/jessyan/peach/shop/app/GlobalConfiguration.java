...
import com.jess.arms.http.okhttp.CookieJarImpl;
import com.jess.arms.http.okhttp.HttpsUtils;
import com.jess.arms.http.okhttp.PersistentCookieStore;
...
//                    okhttpBuilder.sslSocketFactory(); //支持 Https, 详情请百度
                    ...
                    okhttpBuilder
                            ...
                            .cookieJar(new CookieJarImpl(new PersistentCookieStore(context1)))
                            .sslSocketFactory(sslSocketFactory.sSLSocketFactory,sslSocketFactory.trustManager);
//                            .sslSocketFactory(CompatHttps.getSSLSocketFactory(), CompatHttps.trustAllCert);
