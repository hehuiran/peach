...
public class DashView extends View {
    ...
    public DashView(Context context, AttributeSet attrs) {
        ...
        int lineColor = typedArray.getColor(R.styleable.DashView_dv_lineColor, DEFAULT_LINE_COLOR);
        dashOrientation = typedArray.getInteger(R.styleable.DashView_dv_dashOrientation, DEFAULT_DASH_ORIENTATION);
        typedArray.recycle();
