...
import me.jessyan.peach.shop.mine.mvp.model.PlatformNoticeModel;
...
public abstract class PlatformNoticeModule {
    ...
    @Binds
    abstract PlatformNoticeContract.Model bindPlatformNoticeModel(PlatformNoticeModel model);
}